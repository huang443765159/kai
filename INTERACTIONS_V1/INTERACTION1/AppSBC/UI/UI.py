...
class Ui_SBC(object):
    def setupUi(self, SBC):
        ...
        self.tab_pumps_station.setGeometry(QtCore.QRect(10, 250, 371, 221))
        ...
        self.tab_device_2.setGeometry(QtCore.QRect(10, 110, 371, 141))
        ...
        self.tab_device_2.addTab(self.pumpswitch, "")
    ...
    def retranslateUi(self, SBC):
        ...
        self.tab_device_2.setTabText(self.tab_device_2.indexOf(self.pumpswitch), _translate("SBC", "PUMPSWITCH"))
