...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.led_ch_a.setGeometry(QtCore.QRect(131, 20, 18, 14))
        self.led_ch_a.setMinimumSize(QtCore.QSize(0, 14))
        self.led_ch_a.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.led_water = QtWidgets.QToolButton(self.group_robot)
        self.led_water.setGeometry(QtCore.QRect(120, 20, 10, 14))
        self.led_water.setMinimumSize(QtCore.QSize(0, 14))
        self.led_water.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.led_water.setFont(font)
        self.led_water.setToolTip("")
        self.led_water.setToolTipDuration(-1)
        ...
        self.led_ch_b.setGeometry(QtCore.QRect(150, 20, 18, 14))
        self.led_ch_b.setMinimumSize(QtCore.QSize(0, 14))
        self.led_ch_b.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.led_ch_wheel = QtWidgets.QToolButton(self.group_robot)
        self.led_ch_wheel.setGeometry(QtCore.QRect(169, 20, 18, 14))
        self.led_ch_wheel.setMinimumSize(QtCore.QSize(0, 14))
        self.led_ch_wheel.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.led_ch_wheel.setFont(font)
        self.led_ch_wheel.setToolTip("")
        self.led_ch_wheel.setToolTipDuration(-1)
        self.led_ch_wheel.setObjectName("led_ch_wheel")
        self.led_ch_wax = QtWidgets.QToolButton(self.group_robot)
        self.led_ch_wax.setGeometry(QtCore.QRect(188, 20, 18, 14))
        self.led_ch_wax.setMinimumSize(QtCore.QSize(0, 14))
        self.led_ch_wax.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.led_pump_tcp = QtWidgets.QToolButton(self.group_robot)
        self.led_pump_tcp.setGeometry(QtCore.QRect(207, 20, 5, 14))
        self.led_pump_tcp.setMinimumSize(QtCore.QSize(0, 14))
        self.led_pump_tcp.setMaximumSize(QtCore.QSize(1000, 14))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.led_pump_tcp.setFont(font)
        self.led_pump_tcp.setToolTip("")
        self.led_pump_tcp.setToolTipDuration(-1)
        self.led_pump_tcp.setText("")
        self.led_pump_tcp.setObjectName("led_pump_tcp")
...
"ALL"))
        self.led_lb_bot.setText(_translate("MainWindow", "BOT2"))
        self.led_ch_a.setText(_translate("MainWindow", "C1"))
        self.led_water.setText(_translate("MainWindow", "P"))
        self.led_drain.setText(_translate("MainWindow", "DRAIN"))
        self.led_ch_b.setText(_translate("MainWindow", "C2"))
        self.led_ch_wheel.setText(_translate("MainWindow", "WE"))
        self.led_ch_wax.setText(_translate("MainWindow", "WX"))
