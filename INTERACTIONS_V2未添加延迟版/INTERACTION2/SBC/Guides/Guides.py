...
if 'Darwin' in system():
    ...
    PI_GPIO = 1
import struct
from INTERACTION2.XYZAutoNet.NetServer import NetServer
from PyQt5.QtCore import QObject, pyqtSignal
from INTERACTION2.SBC.Guides._Sensors import Sensors
...
class Guides(QObject):
    ...
    def __init__(self, machine_sn, device_type='XYZ-GUIDES'):
        ...
        # GUIDES
        self._guides = Sensors(pi_gpio=PI_GPIO, pins=[21, 26])
