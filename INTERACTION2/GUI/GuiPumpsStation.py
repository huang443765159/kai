...
class GuiPumpsStation(object):
    ...
    def __init__(self, ui, core):
        ...
        # SIGNAL
        self._core.pumps_station.sign_drain_data.connect(self._drain_data)
        ...
        self._core.pumps_station.sign_event.connect(self._pumps_network_event)
        self._core.pumps_station.sign_error.connect(self._pumps_network_error)
        # TEST BTN
        ...
        self._ui.btn_drain.stateChanged.connect(
            lambda x: self._core.pumps_station.pumps_event(pump_type='DRAIN', switch=x))
    ...
    def _pumps_network_event(self, event_type, code, value):
    ...
    def _pumps_network_error(self, error_type, code, error):
