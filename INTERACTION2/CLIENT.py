...
from INTERACTION2.Core import Core
from INTERACTION2.GUI.UI.UI import Ui_MainWindow
from INTERACTION2.GUI.BasicClass.UILed import UILed
from INTERACTION2.GUI.GuiGuides import GuiGuides
from INTERACTION2.GUI.GuiPumpsStation import GuiPumpsStation
...
class RaspGui(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # LED
        self.leds = dict()
        self.leds['GUIDES'] = UILed(self.led_guides, text='OFF')
        ...
        # GUI
        self.gui_guides = GuiGuides(ui=self, core=self._core)
        self.gui_pumps_station = GuiPumpsStation(ui=self, core=self._core)
        # SIGNAL
