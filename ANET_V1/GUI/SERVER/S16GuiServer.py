...
from ANET_V1.GUI.SERVER.UI.UI import Ui_MainWindow
from ANET_V1.AutoNET.NetServer import NetServer
...
class GuiServer(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.ui_tcp_disconnect.stateChanged.connect(self._disconnect)

    def _disconnect(self, switch):
        print(switch)
        self._network.set_device_token('X-SPACE OPEN') if switch else self._network.set_device_token('x')
