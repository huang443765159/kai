...
from ANET_V1.AutoNET.Socket.TcpClient import TcpClient
from ANET_V1.AutoNET.Inviter.InviterRX import InviterRX
...
class NetClient(object):
    ...
    def __init__(self, event_cb, error_cb, tcp_recv_cb, tcp_port, tcp_rx_len=256,
        ...
        self.set_server_ip = self.tcp.set_server_ip
