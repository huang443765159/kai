from ANET_V1.AutoNET.Socket.UDP import UDP
from ANET_V1.AutoNET.Socket.TcpServer import TcpServer
from ANET_V1.AutoNET.Inviter.InviterTX import InviterTX
...
class NetServer(object):
    ...
    def __init__(self, event_cb, error_cb, tcp_recv_cb, tcp_port, tcp_rx_len=256,
        ...
        self.disconnect_all = self.tcp.disconnect_all
