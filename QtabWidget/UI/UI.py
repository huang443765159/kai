...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_reset_record.setText(_translate("Form", "R"))
        self.btn_open_record.setText(_translate("Form", "OPEN_FILE (.rec .npy)"))
        self.label_record.setText(_translate("Form", "REC:"))
        self.area_rec.setTabText(self.area_rec.indexOf(self.tab), _translate("Form", "REC"))
        self.btn_reset_segments.setText(_translate("Form", "R"))
        self.auto_segments.setToolTip(_translate("Form", "Automatic segmentation"))
        self.auto_segments.setText(_translate("Form", "AUTO_SEGMENTS"))
        self.btn_segments.setText(_translate("Form", "SEGM"))
        self.area_seg.setTabText(self.area_seg.indexOf(self.tab_2), _translate("Form", "SEG"))
        self.label_car_pos_x.setText(_translate("Form", "0.00"))
        self.label_car_rot.setText(_translate("Form", "0"))
        self.label_car_pos_z.setText(_translate("Form", "0.00"))
        self.btn_reset_car_pose.setText(_translate("Form", "R"))
        self.label_car.setText(_translate("Form", "CAR:"))
        self.btn_save_car_to_npy_file.setText(_translate("Form", "SAVE_TO_NPY_FILE"))
        self.area_car.setTabText(self.area_car.indexOf(self.tab_3), _translate("Form", "CAR"))
        self.btn_scan_start.setText(_translate("Form", "SCAN_START"))
        self.auto_save_rec_file.setToolTip(_translate("Form", "Automatic segmentation"))
        self.auto_save_rec_file.setText(_translate("Form", "AUTO_SAVE"))
        self.btn_save_as_rec_file.setText(_translate("Form", "SAVE_TO_REC"))
        self.area_scan.setTabText(self.area_scan.indexOf(self.tab_4), _translate("Form", "SCAN"))
