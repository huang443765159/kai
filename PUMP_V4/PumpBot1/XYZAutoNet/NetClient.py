...
from .Socket.TcpClient import TcpClient
from .Inviter.InviterRX import InviterRX
...
class NetClient(object):
    ...
    def set_invitation_accepting_ena(self, ena: bool):
        self._inviterRX.set_enable(ena=ena)

    def get_invitation_accepting_ena(self):
...
if __name__ == '__main__':
    ...
    client.set_invitation_accepting_ena(ena=True)
    while 1:
        time.sleep(1)
