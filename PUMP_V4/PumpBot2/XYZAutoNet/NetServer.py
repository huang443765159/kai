from .Socket.UDP import UDP
from .Socket.TcpServer import TcpServer
from .Inviter.InviterTX import InviterTX
...
class NetServer(object):
    ...
    def set_invitation_broadcast_ena(self, ena: bool):
        self._inviterTX.set_enable(ena=ena)

    def get_invitation_broadcast_ena(self):
...
if __name__ == '__main__':
    ...
    server.set_invitation_broadcast_ena(ena=True)
    while 1:
        time.sleep(1)
