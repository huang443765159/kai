...
from PumpBot2.SBC.OnePump._Channels import Channels
from PumpBot2.Util.DEFINES import NETWORK as NET
from PumpBot2.XYZAutoNet.NetServer import NetServer
