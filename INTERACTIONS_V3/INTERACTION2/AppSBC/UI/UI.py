...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.led_drain.setGeometry(QtCore.QRect(160, 50, 37, 20))
        self.led_drain.setMinimumSize(QtCore.QSize(0, 20))
        ...
        self.led_guides_data1 = QtWidgets.QToolButton(self.group_robot)
        self.led_guides_data1.setGeometry(QtCore.QRect(80, 50, 21, 20))
        self.led_guides_data1.setMinimumSize(QtCore.QSize(0, 14))
        self.led_guides_data1.setMaximumSize(QtCore.QSize(1000, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.led_guides_data1.setFont(font)
        self.led_guides_data1.setToolTip("")
        self.led_guides_data1.setToolTipDuration(-1)
        self.led_guides_data1.setObjectName("led_guides_data1")
        self.led_guides_data2 = QtWidgets.QToolButton(self.group_robot)
        self.led_guides_data2.setGeometry(QtCore.QRect(100, 50, 21, 20))
        self.led_guides_data2.setMinimumSize(QtCore.QSize(0, 14))
        self.led_guides_data2.setMaximumSize(QtCore.QSize(1000, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.led_guides_data2.setFont(font)
        self.led_guides_data2.setToolTip("")
        self.led_guides_data2.setToolTipDuration(-1)
        self.led_guides_data2.setObjectName("led_guides_data2")
        self.led_tcp_guides = QtWidgets.QToolButton(self.group_robot)
        self.led_tcp_guides.setGeometry(QtCore.QRect(120, 50, 16, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "BOT2"))
...
"ALL"))
        ...
        self.led_guides_data1.setText(_translate("MainWindow", "G1"))
        self.led_guides_data2.setText(_translate("MainWindow", "G2"))
