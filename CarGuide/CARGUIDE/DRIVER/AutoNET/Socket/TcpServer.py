...
class TcpServer(object):
    ...
    def _working(self):
        ...
        # self._tcp.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 4194304)
        # self._tcp.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 4194304)
...
if __name__ == '__main__':
    ...
    while 1:
        time.sleep(2)
        server.send_broadcast(b'\x12\x11')
