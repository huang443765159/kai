...
import threading
import time
from LEDDISPLAY.DRIVE.AutoNET.Socket._Tool import get_my_ip
    ...
    def _working(self):
        ...
        while 1:
            if self._is_bound:
                ...
                self._udp.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 3500000)
                self._udp.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 3500000)
