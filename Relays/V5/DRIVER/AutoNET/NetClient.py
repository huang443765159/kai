from QTimer任务流模块.DRIVER.AutoNET.Socket.UDP import UDP
from QTimer任务流模块.DRIVER.AutoNET.Socket.TcpClient import TcpClient
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        client.tcp.send(b' what is your name')
        client.tcp.send(b'jim' * 1000)
